...
function make_clone(app, mccoy, drop_container) {
  return Pixi$Sweeneyville.Sprite[/* listen */11](mccoy, "mousedown", (function ($$event) {
                ...
                var relative_position = Pixi$Sweeneyville.App[/* to_local */5](drop_container, Pixi$Sweeneyville.Sprite[/* global_position */7](copy));
